...
public class OverlapWFC : MonoBehaviour
{
    ...
    public void Generate()
    {
        ...
        // En runtime, pas de PrefabUtility ,on utilise simplement l’objet original
#if UNITY_EDITOR
...
#else
		   // En runtime : on utilise directement le training déjà dans la scène
#endif
        ...
        {
            // Recompile pour supporter le changement dynamique
            training.Compile();
        }
    ...
    public void SetTraining(Training newTraining)
    {
        ...
        training.Compile(); // mettre à jour l’échantillon
        Generate();         // relancer une génération complète
    }
